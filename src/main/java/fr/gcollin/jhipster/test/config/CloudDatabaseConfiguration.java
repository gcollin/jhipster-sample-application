package fr.gcollin.jhipster.test.config;
...
@Configuration
@EnableMongoRepositories("fr.gcollin.jhipster.test.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.gcollin.jhipster.test.config.dbmigrations");
